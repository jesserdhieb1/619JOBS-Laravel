...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" >619 JOBS</a>
      ...
      @if (Route::has('login'))   
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="nav-link ">S'identifier</a>
                    @endif
                @endauth
        @endif  
...
<img src="/img/logo.PNG" class="img-fluid " width="100%" alt="logo">

<div class="container text-muted my-5">
<div class="text-center ">
        <h2>Qui somme nous ?...</h2>
        <p class="lead">quelques informations a propos de nous </p>
      </div>
...
<div class="text-muted  mt-4">
    <h5 class="text-center">Copyright @619JOBS 2021-2022</h5>
</div>
